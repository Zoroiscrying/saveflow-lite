...
### `addons/saveflow_lite/runtime/core`

- [save_flow.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/core/save_flow.gd)
  The autoload runtime. Owns slot IO, graph traversal, diagnostics, and entity-factory registration.
- [saveflow_source.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/core/saveflow_source.gd)
  Base leaf contract. Every source gathers save data and applies save data.
- [saveflow_scope.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/core/saveflow_scope.gd)
  Graph grouping node. Organizes domains and restore order.

### `addons/saveflow_lite/runtime/sources`
...
### `addons/saveflow_lite/runtime/entities`
...
### `addons/saveflow_lite/runtime/serializers`

- [saveflow_built_in_serializer.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/serializers/saveflow_built_in_serializer.gd)
  Base serializer contract for engine-provided node state.
- [saveflow_built_in_serializer_registry.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/serializers/saveflow_built_in_serializer_registry.gd)
  Registry of built-in serializers used by `SaveFlowNodeSource`.
- [saveflow_serializer_node2d.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/serializers/saveflow_serializer_node2d.gd)
- [saveflow_serializer_node3d.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/serializers/saveflow_serializer_node3d.gd)
- [saveflow_serializer_control.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/serializers/saveflow_serializer_control.gd)
- [saveflow_serializer_animation_player.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/serializers/saveflow_serializer_animation_player.gd)
  First-wave built-in serializers for common Godot node types.

### `addons/saveflow_lite/runtime/types`

- [save_result.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/types/save_result.gd)
  Common result wrapper returned by SaveFlow operations.
- [save_settings.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/types/save_settings.gd)
  Runtime save settings model.
- [save_error.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/types/save_error.gd)
- [save_format.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/types/save_format.gd)
- [save_log_level.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/types/save_log_level.gd)
...
2. [save_flow.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/core/save_flow.gd)
3. [saveflow_node_source.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/sources/saveflow_node_source.gd)
4. [saveflow_data_source.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/sources/saveflow_data_source.gd)
5. [saveflow_entity_collection_source.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/entities/saveflow_entity_collection_source.gd)
6. [saveflow_prefab_entity_factory.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/entities/saveflow_prefab_entity_factory.gd)
7. [saveflow_entity_factory.gd](F:/Coding-Projects/Godot/plugin-development/addons/saveflow_lite/runtime/entities/saveflow_entity_factory.gd)
