...
const EntityPrefabScene := preload("res://addons/saveflow_lite/demo/zelda_like/scenes/prefabs/zelda_like_entity_prefab.tscn")
const RoomEntityStateScript := preload("res://addons/saveflow_lite/demo/zelda_like/gameplay/zelda_like_room_entity_state.gd")
